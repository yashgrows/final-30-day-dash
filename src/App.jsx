...
const ChallengeTracker = () => {
  ...
  const INITIAL_USERS = [
    ...
    { id: 6, name: "Dhruv", habits: ["Meditate for 10 mins daily", "Read non-fiction for 30 mins daily", "Journal daily","Workout"] },
    { id: 7, name: "Meghan", habits: ["Gym", "3hrs of study", "No fried/fast food","3hrs of sim racing"] },
    ...
    { id: 26, name: "Jay", habits: ["Daily exercise", "Read for 20 mins daily","Less than 20g of sugar daily"] },
  ];
